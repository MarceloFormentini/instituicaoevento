...
import fullstack.cresol.events.dto.InstituicaoDTO;
import fullstack.cresol.events.model.Instituicao;
import fullstack.cresol.events.service.InstituicaoService;
...
public class InstituicaoController {
	...
	public ResponseEntity<?> updateInstitution(@Valid @RequestBody Instituicao novaInstituicao){

		Instituicao instituicao = service.updateInstitution(novaInstituicao);
