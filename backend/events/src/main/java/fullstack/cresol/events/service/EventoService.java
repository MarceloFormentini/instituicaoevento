...
import fullstack.cresol.events.exception.EventoDataIncorretaException;
import fullstack.cresol.events.exception.EventoInstituicaoIncompativelException;
import fullstack.cresol.events.exception.EventoNotFoundException;
import fullstack.cresol.events.exception.InstituicaoNotFoundException;
import fullstack.cresol.events.messaging.EventoProducer;
...
//		eventoProducer.agendarInativacaoEvento(eventoSalvo.getId(), eventoSalvo.getDataFinal());
	...
	public Evento updateEvent(Integer instituicao, EventoDTO evento) {
